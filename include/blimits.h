...
//#define MAX_PARAS		26	/* максимальное число абзацев в принятом ответе */
#define MAX_PARAS		16380	/* максимальное число абзацев в принятом ответе */
...
#define KLOG_BUF_LEN		262144	/* размер буфера данных КЛ ККТ */
